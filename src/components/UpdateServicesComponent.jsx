...
class UpdateServicesComponent extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount(){
        ServicesService.getServicesById(this.state.id).then( (res) =>{
    ...
    updateServices = (e) => {
        ...
        console.log('servicesId => ' + JSON.stringify(this.state.servicesId));
        ServicesService.updateServices(services, this.state.servicesId).then( res => {
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.updateServices}>Save</button>
...
export default UpdateServicesComponent